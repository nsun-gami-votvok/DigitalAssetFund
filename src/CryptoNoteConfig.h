...
const uint64_t MONEY_SUPPLY                                  =UINT64_C(80000000);
...
const uint64_t MINIMUM_FEE                                   = ;50000000
...
const char     CRYPTONOTE_NAME[]                             = "DigitalAssetFund";
...
const int      P2P_DEFAULT_PORT                              = 51235;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 5005;
